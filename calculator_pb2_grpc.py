...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SqureRoot = channel.unary_unary(
                '/Calculator/SqureRoot',
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SqureRoot': grpc.unary_unary_rpc_method_handler(
                    servicer.SqureRoot,
...
class Calculator(object):
    ...
    def SqureRoot(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Calculator/SqureRoot',
